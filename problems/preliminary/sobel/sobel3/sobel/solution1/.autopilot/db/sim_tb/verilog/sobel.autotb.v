...
`define AUTOTB_TVIN_gmem  "./c.sobel.autotvin_gmem.dat"
`define AUTOTB_TVIN_src  "./c.sobel.autotvin_src.dat"
`define AUTOTB_TVIN_dst  "./c.sobel.autotvin_dst.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.sobel.autotvin_gmem.dat"
`define AUTOTB_TVIN_src_out_wrapc  "./rtl.sobel.autotvin_src.dat"
`define AUTOTB_TVIN_dst_out_wrapc  "./rtl.sobel.autotvin_dst.dat"
`define AUTOTB_TVOUT_gmem  "./c.sobel.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.sobel.autotvout_gmem.dat"
module `AUTOTB_TOP;
