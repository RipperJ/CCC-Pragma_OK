...
PIXEL sobel_kernel(PIXEL window [][3]) {
	...
	// PIXEL temp1 = window[1][2] + window[1][2], temp2 = window[1][0] + window[1][0];
	// sumx = (window[0][2] + temp1 + window[2][2]) - (window[0][0] + temp2 + window[2][0]);
	// PIXEL temp3 = window[2][1] + window[2][1], temp4 = window[0][1] + window[0][1];
	// sumy = (window[2][0] + temp3 + window[2][2]) - (window[0][0] + temp4 + window[0][2]);
