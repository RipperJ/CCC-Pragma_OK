...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_db_insert_sort_function.autotvin_din_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvin_kin_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvin_strm_in_end_V.dat"
         "c.hls_db_insert_sort_function.autotvin_dout_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvin_kout_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvin_strm_out_end_V.dat"
         "c.hls_db_insert_sort_function.autotvin_sign.dat"
         "c.hls_db_insert_sort_function.autotvout_dout_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvout_kout_strm_V.dat"
         "c.hls_db_insert_sort_function.autotvout_strm_out_end_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_db_insert_sort_function.autotvout_dout_strm_V.dat"
         "rtl.hls_db_insert_sort_function.autotvout_kout_strm_V.dat"
         "rtl.hls_db_insert_sort_function.autotvout_strm_out_end_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
