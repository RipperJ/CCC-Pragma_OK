...
module AESL_autofifo_kout_strm_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.hls_db_insert_sort_function.autotvin_kout_strm_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.hls_db_insert_sort_function.autotvout_kout_strm_V.dat";
