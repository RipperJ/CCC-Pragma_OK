set moduleName dataflow_in_loop_VITIS_LOOP_49_1
set isTopModule 0
...
set C_modelName {dataflow_in_loop_VITIS_LOOP_49_1}
...
set portList { 
	...
	{ src_address0 sc_out sc_lv 20 signal 2 } 
	{ src_ce0 sc_out sc_logic 1 signal 2 } 
	{ src_d0 sc_out sc_lv 16 signal 2 } 
	{ src_q0 sc_in sc_lv 16 signal 2 } 
	{ src_we0 sc_out sc_logic 1 signal 2 } 
	{ src_address1 sc_out sc_lv 20 signal 2 } 
	{ src_ce1 sc_out sc_logic 1 signal 2 } 
	{ src_d1 sc_out sc_lv 16 signal 2 } 
	{ src_q1 sc_in sc_lv 16 signal 2 } 
	{ src_we1 sc_out sc_logic 1 signal 2 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ row_ap_vld sc_in sc_logic 1 invld 0 } 
...
set NewPortList {[ 
	{ "name": "row", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "row", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "VITIS_LOOP_51_2_proc_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "VITIS_LOOP_51_2_proc_U0"}],
		"Port" : [
			...
			{"Name" : "dst", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "VITIS_LOOP_51_2_proc_U0", "Port" : "dst"}]},
			{"Name" : "src", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "VITIS_LOOP_51_2_proc_U0", "Port" : "src"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "dst", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "src", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0.buffer_a_1_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0.buffer_b_1_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0.buffer_a_2_U", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0.buffer_b_2_U", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.VITIS_LOOP_51_2_proc_U0.mul_mul_10ns_12ns_20_4_1_U1", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	row { ap_none {  { row in_data 0 10 }  { row_ap_vld in_vld 0 1 } } }
