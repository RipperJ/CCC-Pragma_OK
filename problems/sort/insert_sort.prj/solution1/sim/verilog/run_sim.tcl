...
if {[file isfile hls_db_insert_sort_function.autotvin.dat]} {
	file delete -force hls_db_insert_sort_function.autotvin.dat
}

if {[file isfile hls_db_insert_sort_function.autotvout.dat]} {
	file delete -force hls_db_insert_sort_function.autotvout.dat
}
